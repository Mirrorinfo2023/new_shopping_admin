...
import { Save, User, Lock, Bell, Globe, Moon, Sun, Shield, Database, Check } from "lucide-react";
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className={`w-11 h-6 rounded-full peer ${formData.notifications.email ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'} peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800`}>
                          <div className={`absolute top-0.5 left-0.5 bg-white border rounded-full h-5 w-5 transition-transform ${formData.notifications.email ? 'transform translate-x-5' : ''}`}></div>
                        </div>
                      </label>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className={`w-11 h-6 rounded-full peer ${formData.notifications.orderUpdates ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'} peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800`}>
                          <div className={`absolute top-0.5 left-0.5 bg-white border rounded-full h-5 w-5 transition-transform ${formData.notifications.orderUpdates ? 'transform translate-x-5' : ''}`}></div>
                        </div>
                      </label>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className={`w-11 h-6 rounded-full peer ${formData.notifications.lowStock ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'} peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800`}>
                          <div className={`absolute top-0.5 left-0.5 bg-white border rounded-full h-5 w-5 transition-transform ${formData.notifications.lowStock ? 'transform translate-x-5' : ''}`}></div>
                        </div>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                      ...
                      <div className="space-y-2">
                        <button 
                          type="button"
                          className="w-full px-3 py-2 text-xs border border-red-500 text-red-600 dark:text-red-400 rounded-md hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
                        >
                          Clear All Data
                        </button>
                        <button 
                          type="button"
                          className="w-full px-3 py-2 text-xs bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors"
                        >
                          Delete Account
                        </button>
                      </div>
