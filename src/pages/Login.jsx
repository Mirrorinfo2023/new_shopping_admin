...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log("Login Dispatch Result:", actionResult); // Debugging Redux result
    ...
    <div className="flex items-center justify-center min-h-screen px-4 bg-gradient-to-br from-blue-900 to-blue-600">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-sm md:max-w-[420px]">
        ...
        <form onSubmit={handleLogin}>
          ...
          {error && <div className="p-3 mb-4 text-sm bg-red-100 text-red-600 rounded-lg">{error}</div>}
          <button type="submit" disabled={status === "loading"} className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700">
